...
std::string CoefNaming::lumi_fraction_name(const std::string &pol_config,
                                           int energy,
                                           std::string energy_unit) {
  /** Convention for naming the luminosity fraction coefficient.
   **/
  return "LumiFr" + pol_config + std::to_string(energy) + energy_unit;
}

//------------------------------------------------------------------------------

std::string
CoefNaming::lumi_fraction_name(const PrEW::Data::DistrInfo &info_pol,
                               std::string energy_unit) {
  /** Convention for naming the luminosity fraction coefficient.
   **/
  return "LumiFr" + info_pol.m_pol_config + std::to_string(info_pol.m_energy) +
         energy_unit;
}
...
std::string
CoefNaming::chi_xs_coef_name(const PrEW::Data::DistrInfo &info_chi) {
